...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 16 Bulan Mei 2023 pada 05.29
...
(12345, 'Tenggelamnya Jukung Ani', 'Ipul Hary', 'Kadatahu', 2017);
...
(2147483647, 'Drii', '28', 'Bjm', '2023-05-15 23:04:00', '2023-05-15');
...
--
ALTER TABLE `member`
  MODIFY `id_member` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2147483648;

--
-- AUTO_INCREMENT untuk tabel `peminjaman`
--
ALTER TABLE `peminjaman`
  MODIFY `id_peminjaman` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1233233;
COMMIT;
